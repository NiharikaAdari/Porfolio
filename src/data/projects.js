export const projects = [
  {
    ...
    longDescription: "StudyKeet is a full-stack AI learning environment that helps students with deep learning and long-term retention of their materials. It brings two science-backed learning frameworks together: the Feynman Technique for active recall and the Leitner System for spaced repetition. Students can upload text, PDFs, or URLs and generate summaries, ask RAG-powered queries, build and edit flashcards, take notes, run Leitner learning sessions, or evaluate their understanding through typed or recorded explanations.\n\nAll study materials are organized in 'Nests' (class folders), where each uploaded source becomes an 'egg' that can be summarized, queried, taught, or transformed into flashcards. The study board centralizes actions like summary generation, flashcard extraction, note-taking, and Pomodoro focus sessions.\n\nThe Feynman module provides coverage and accuracy scoring, highlights misunderstandings using a 'Said → Actually' format with evidence, and automatically generates corrective flashcards. The Leitner module supports four adaptive review nests for spaced repetition and mastery. The flashcard dashboard enables review sessions, CRUD operations, color-coding, filtering, bulk deletion, and Q/A toggling.\n\nA built-in animated parakeet companion offers science-backed study tips.\n\nStudyKeet demonstrates full-stack engineering, AI/ML integration, RAG pipelines, and user-centered learning design.",
